                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            Pratinjau dan proses verifikasi surat
                        </p>
                    </div>

                    <a href="{{ route('verifikator.surat-masuk.index') }}"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl border shadow-sm p-5 space-y-3">
                            ...
                            @if($showTtd && $stepSaya)
                                <form method="POST"
                                      action="{{ route('verifikator.surat-masuk.ttd', $surat) }}"
                            ...
                            @elseif($showApproveReject && $stepSaya)

                                <form method="POST"
                                      action="{{ route('verifikator.surat-masuk.setujui', $surat) }}"
                                ...
                                <form method="POST"
                                      action="{{ route('verifikator.surat-masuk.tolak', $surat) }}"
...
<div id="revisiModal"
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
        ...
        <form method="POST"
              action="{{ route('verifikator.surat-masuk.revisi', $surat) }}"
              class="space-y-4">
            @csrf
            ...
            <textarea
                ...
                placeholder="Tuliskan alasan dan catatan revisi..."></textarea>
