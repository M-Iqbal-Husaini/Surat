                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-xl font-semibold text-slate-800">
                            Detail Surat Keluar (Sekretaris Direktur)
                        </h1>
                        <p class="text-sm text-slate-500">
                            Surat yang telah atau sedang diproses oleh Sekretaris Direktur
                        </p>
                    </div>

                    <a href="{{ route('sekretaris-direktur.surat-keluar.index') }}"
